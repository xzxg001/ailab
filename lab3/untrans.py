...
if __name__ == "__main__":
    ...
    all_warmup_steps = int(total_steps * 0.08636053732173797)
    ...
    # )
    writer = SummaryWriter('/old_home/lyt/zxj_workplaces/ailab/CodeWithDataset/lab3/log/untrans')
    mymodel = MyDLmodel(
    pretrained_model, 
    device, 
    num_training_steps=total_steps, 
    num_warmup_steps=all_warmup_steps, 
    lr= 9.045793537846035e-06,
    alpha=1.7882510867588342,
    gamma=1.553011291530688,
    weight_decay=0.0028470715028778735
)
