...
# In training loop
    def train(self, dataloader_train, dataloader_dev, epochs):
        ...
        # Rest of the training loop
            print(f"Epoch {epoch+1} / {epochs}: Train Loss: {total_loss/len(dataloader_train):.4f}")
...
# Load model directly
    ...
    all_warmup_steps = int(total_steps * 0.09088533364779913)
    ...
    # )
    writer = SummaryWriter('/old_home/lyt/zxj_workplaces/ailab/CodeWithDataset/lab3/log/new')
    ...
    lr= 4.175422775879548e-06,
    alpha=1.481519748762507,
    gamma=1.9048230406599715,
    weight_decay=0.00036101129667459147
)
    ...
    ## 写入预测结果
    # 保存模型
    mymodel.save_model('/old_home/lyt/zxj_workplaces/ailab/CodeWithDataset/model/roberta_finetuned.pth')
