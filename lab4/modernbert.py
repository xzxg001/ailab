...
class MultiModalModel(nn.Module):
    def __init__(self, text_model, audio_feature_dim, num_classes):
        ...
        self.classifier = nn.Linear(128 + 768, num_classes)  # BERT 输出维度为 768
...
# 替换 BertForSequenceClassification 为 ModernBERT
    bert_model = ModernBertModel.from_pretrained("answerdotai/ModernBERT-base", num_labels=4)
